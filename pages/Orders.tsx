        ...
        <div className="grid grid-cols-1 gap-6">
          {commandes.length === 0 ? (
            ...
            commandes.map((commande, idx) => (
              <div 
                key={commande.id} 
                onClick={() => navigate(`/orders/${commande.id}`)}
              ...
              >
                ...
                <div className="flex items-center gap-7">
                  ...
                  <div>
                    <div className="flex items-center gap-5 mb-2">
                      ...
                      <span className={`text-[11px] uppercase tracking-widest px-4 py-1.5 rounded-full border-2 font-black ${statusInfo(commande.status).color}`}>
                        {statusInfo(commande.status).label}
                      </span>
                    </div>
                ...
                <div className="flex items-center gap-10">
                  <div className="text-right">
                    <p className="text-4xl font-black text-slate-900">{commande.total} DH</p>
                  </div>
