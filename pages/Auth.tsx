...
/* ── Inline Google "G" logo (avoids external dependency) ──────────────── */
const GoogleIcon = () => (
...
const Auth: React.FC = () => {
  ...
  /* ── Shared Google button rendered in both tabs ────────────────────── */
  const GoogleButton = () => (
    <>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div
        className={`w-full ${isLogin ? 'max-w-md' : 'max-w-2xl'} bg-white border border-slate-200 rounded-[2.5rem] p-10 shadow-2xl relative z-10 animate-scale-in transition-all duration-500`}
      >
        {/* Logo */}
          ...
          <form onSubmit={handleLogin} className="space-y-5 animate-fade-in">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <UserCircle
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-gold transition-colors"
                  size={20}
                />
                <input
                  type="text"
          ...
          <form onSubmit={handleRegister} className="space-y-6 animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <UserCircle
                    className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-gold"
                    size={18}
                  />
                  <input
                    type="text"
        ...
        <div className="mt-8 text-center animate-fade-in">
          ...
          >
            {isLogin
              ? "Pas encore membre ? Rejoignez l'élite ArchiWalls"
              : 'Déjà membre ? Retour à la connexion'}
          </button>
        </div>
      </div>
    </div>
